...
public class FirebaseMethods {
    ...
    private void setBackgroundPhoto(String url){
        Log.d(TAG, "setBackgroundPhoto: setting new Background image: " + url);

        myRef.child(mContext.getString(R.string.dbname_user_account_settings))
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                .child(mContext.getString(R.string.Background_photo))
                .setValue(url);
    }

    private String getTimestamp(){
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'", Locale.ENGLISH);
        sdf.setTimeZone(TimeZone.getTimeZone("UTC+03:00"));
 ...
 public boolean checkIfUsernameExists(String username, DataSnapshot datasnapshot){
     ...
     * @param profile_photo
     */
    public void addNewUser(String email, String username, String description, String website, String profile_photo, String background_photo){
